...
class TextworldGamesEnv(gym.Env):
    ...
    def __init__(self, game_files: List[str],
        ...
        Arguments:
            ...
            action_space:
                ...
                :py:class:`tw_textlabs.gym.spaces.Word <tw_textlabs.gym.spaces.text_spaces.Word>`
    ...
    def step(self, command) -> Tuple[str, Dict[str, Any]]:
        ...
        self.ob, score, done, infos = self.tw_textlabs_env.step(self.last_command)
