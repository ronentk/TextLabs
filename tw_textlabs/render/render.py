...
import tw_textlabs
from tw_textlabs.logic import Variable, Proposition, Action
from tw_textlabs.envs.glulx.git_glulx_ml import GlulxGameState
from tw_textlabs.logic import State
from tw_textlabs.generator import World, Game
from tw_textlabs.utils import maybe_mkdir, get_webdriver
...
def visualize(world: Union[Game, State, GlulxGameState, World],
    ...
    try:
        import webbrowser
        from tw_textlabs.render.serve import get_html_template
    except ImportError:
        raise ImportError('Visualization dependencies not installed. Try running `pip install tw_textlabs[vis]`')
    ...
    tmpdir = maybe_mkdir(pjoin(tempfile.gettempdir(), "tw_textlabs"))
