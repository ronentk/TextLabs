...
from tw_textlabs.generator.text_grammar import Grammar, GrammarOptions
from tw_textlabs.generator.world import World
from tw_textlabs.logic import Action, Proposition, Rule, State, CompactAction
from tw_textlabs.generator.vtypes import VariableTypeTree
from tw_textlabs.generator.graph_networks import DIRECTIONS

from tw_textlabs.generator.chaining import ChainingOptions

from tw_textlabs.generator.dependency_tree import DependencyTree
from tw_textlabs.generator.dependency_tree import DependencyTreeElement
        ...
        seeds (Optional[Union[int, Dict]]):
            Seeds for the different generation processes.
               ...
               * If `None`, seeds will be sampled from
                 :py:data:`tw_textlabs.g_rng <tw_textlabs.utils.g_rng>`.
               ...
               * If dict, the following keys can be set:
                 ...
                 * `'grammar'`: control the text generation.
                 ...
                 from :py:data:`tw_textlabs.g_rng <tw_textlabs.utils.g_rng>`).
        kb (KnowledgeBase):
            The knowledge base containing the logic and the text grammars (see
            :py:class:`tw_textlabs.generator.KnowledgeBase <tw_textlabs.generator.data.KnowledgeBase>`
            for more information).
        chaining (ChainingOptions):
            For customizing the quest generation (see
            :py:class:`tw_textlabs.generator.ChainingOptions <tw_textlabs.generator.chaining.ChainingOptions>`
