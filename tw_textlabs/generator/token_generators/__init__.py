...
from tw_textlabs.generator.token_generators.token_generator import TokenGenerator
from tw_textlabs.generator.token_generators.token_generator import DYN_TOKEN_MARKER
...
def grab(token_name, *args, **kwargs):
    ...
    try:
        ...
        token_module = import_module('.' + module_name, package='tw_textlabs.generator.token_generators')
