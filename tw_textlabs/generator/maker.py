...
from tw_textlabs.generator import user_query
from tw_textlabs.generator.vtypes import get_new
from tw_textlabs.logic import State, Variable, Proposition, Action
from tw_textlabs.generator.game import Game, World, Quest, Event
from tw_textlabs.generator.graph_networks import DIRECTIONS
from tw_textlabs.render import visualize
from tw_textlabs.envs.wrappers import Recorder
...
class WorldEntity:
    ...
    def has_property(self, name: str) -> bool:
        ...
        Example:
            >>> from tw_textlabs import GameMaker
            >>> M = GameMaker()
...
class GameMaker:
    ...
    def add_random_quest(self, max_length: int) -> Quest:
        ...
        """
        world = World.from_facts(self.facts)
        self.quests.append(tw_textlabs.generator.make_quest(world, max_length))
    ...
    def record_quest(self, ask_for_state: bool = False) -> Quest:
        ...
        with make_temp_directory() as tmpdir:
            ...
            recorder = Recorder()
            tw_textlabs.play(game_file, wrapper=recorder)
    ...
    def set_quest_from_commands(self, commands: List[str], ask_for_state: bool = False) -> Quest:
        ...
        with make_temp_directory() as tmpdir:
            try:
                ...
                tw_textlabs.play(game_file, agent=agent, wrapper=recorder, silent=True)
    ...
    def compile(self, path: str) -> str:
        ...
        game_file = tw_textlabs.generator.compile_game(self._working_game, path, force_recompile=True)
        return game_file
