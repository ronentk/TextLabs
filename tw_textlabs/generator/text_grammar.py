...
from tw_textlabs.textgen.model import AdjectiveNoun, Match, TextGrammarModelBuilderSemantics
from tw_textlabs.textgen.parser import TextGrammarParser
    ...
    def generate_name(self, obj_type: str, room_type: str = "",
        ...
        if not found_candidate:
            ...
            if not include_adj:
                ...
                warnings.warn(msg, tw_textlabs.TextworldGenerationWarning)
                return name, adj, noun
