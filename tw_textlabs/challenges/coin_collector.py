...
import tw_textlabs
from tw_textlabs.generator.graph_networks import reverse_direction
...
def make_game_from_level(level: int, options: Optional[GameOptions] = None) -> tw_textlabs.Game:
...
def make_game(mode: str, options: GameOptions) -> tw_textlabs.Game:
    ...
    M.grammar = tw_textlabs.generator.make_grammar(options.grammar, rng=rng_grammar)
