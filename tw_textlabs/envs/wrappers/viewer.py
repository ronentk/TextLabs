...
from tw_textlabs.core import Environment, GameState, Wrapper
...
class HtmlViewer(Wrapper):
    ...
    def reset(self) -> GameState:
        ...
        try:
            from tw_textlabs.render.serve import VisualizationService
            ...
            print("Importing HtmlViewer without installed dependencies. Try re-installing tw_textlabs.")
