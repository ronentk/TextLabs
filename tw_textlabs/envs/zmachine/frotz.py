...
import tw_textlabs
from tw_textlabs.core import GameState
from tw_textlabs.core import GameNotRunningError

FROTZ_PATH = resource_filename(Requirement.parse('tw_textlabs'), 'tw_textlabs/thirdparty/frotz')
...
class FrotzEnvironment(tw_textlabs.Environment):
    ...
    that reason :py:class:`tw_textlabs.envs.JerichoEnviroment
    <tw_textlabs.envs.zmachine.jericho.JerichoEnviroment>` is preferred.
    """
