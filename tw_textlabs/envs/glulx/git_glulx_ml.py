...
import tw_textlabs
from tw_textlabs.generator.game import Game, GameProgression
...
GLULX_PATH = resource_filename(Requirement.parse('tw_textlabs'), 'tw_textlabs/thirdparty/glulx/Git-Glulx')
...
class GlulxGameState(tw_textlabs.GameState):
    """
    ...
    def __init__(self, *args, **kwargs):
        """
        Takes the same parameters as tw_textlabs.GameState
...
class GitGlulxMLEnvironment(tw_textlabs.Environment):
